...
{/* TODO: Link to core concept of SSG/SSR, etc. _/}
{/_ TODO: Link to mobile development server guide _/}
{/_ TODO: Concept of how to do a client-server relationship? */}
...
1. ##### Install `@sveltejs/adapter-static`
   ...
   deno="deno add -D npm:@sveltejs/ad
...
>
  ...
  >A newer version of MyApplicationName is already installed.</String>
  <String Id="PathEnvVarFeature"
  >Add the install location of the MyApplicationName executable to
    the PATH system environment variable. This allows the
    MyApplicationName executable to be called from any location.</String>
...
- <Icon name="external" class="inline-icon" /> [Through the Window in Rust](https://docs.rs/tauri/2.0.0/tauri/window/struct.Window.html)
...
4. ### Find the Right Permissions
   ...
   5. ### Test Permissions in Practice
      ...
      window.addEventListener("DOMContentLoaded", () => {
        ...
        document.querySelector("#greet-form")?.addEventListener(
          "submit",
          (e) => {
            e.preventDefault();
            if (!greetInputEl) {
